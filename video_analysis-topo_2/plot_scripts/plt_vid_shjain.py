...
def main():
	...
	file_name = 'all_vid_shjain.csv'

	plt_title = 'Jain Fairness Index (Case %s)'
	...
	for i in xrange(2):
		...
		jain_hd = csv_data_np[plt_num + 4*i][0::2] # at even position 0 2 4
		jain_sd = csv_data_np[plt_num + 4*i][1::2] # at odd position 1 3 5
	...
	plt.grid(True)
	plt.xlabel('Time Period (sec)', fontsize = plt_font_size_axis - 2)
	plt.ylabel('Fairness Value', fontsize = plt_font_size_axis)
